module.exports = {
  siteTitle: 'SEOSmash',
  siteTitleAlt: 'Smash the serach engines with our tips', // This allows an alternative site title for SEO schema.
  publisher: 'SEOSmash Inc.', // Organization name used for SEO schema
  siteDescription:
    'Smash the serach engines with our tips',
  ...
  author: 'SEOSmasher', // Author for RSS author segment and SEO schema
  ...
  shortTitle: 'SEOSmash', // Used for App manifest e.g. Mobile Home Screen
  ...
  copyright: 'Copyright © 2018 SEOSmash', // Copyright string for the RSS feed
}
